...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "trainval2017"/"images", root / "annotations" / f'{mode}_trainval2017.json'),
        ...
        "eval_debug": (root / "val2017"/"images", root / "annotations" / f'{mode}_val2017.json'),
        "test": (root / "test2017"/"images", root / "annotations" / f'{mode}_test2017.json'),
    }
