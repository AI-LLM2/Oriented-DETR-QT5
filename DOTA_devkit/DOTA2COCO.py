...
class_Names = ['plane', 'small-vehicle', 'large-vehicle', 'ship', 'harbor', 'helicopter']
...
if __name__ == '__main__':
    image_dir_path = "/root/autodl-tmp/Oriented-DETR/data/OHD-SJTU/ohd2017/trainval/images/"
    label_dir_path = "/root/autodl-tmp/Oriented-DETR/data/OHD-SJTU/ohd2017/trainval/labels/"
    save_file_name = '/root/autodl-tmp/Oriented-DETR/data/OHD-SJTU/ohdcoco/annotations/instances_trainval2017.json'
