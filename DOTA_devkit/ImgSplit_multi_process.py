...
if __name__ == '__main__':
    split = splitbase(basepath="/root/autodl-tmp/Oriented-DETR/data/OHD-SJTU/ohd/trainval/",
                      outpath="/root/autodl-tmp/Oriented-DETR/data/OHD-SJTU/ohd2017/trainval2017_split_rate1.0_subsize1024_gap200",
                      gap=200,
                      subsize=1024,
                      num_process=8)                 
    split.splitdata(1) 